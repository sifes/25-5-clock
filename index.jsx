function App() {
    ...
    function onSessionInc() {
        if (isPlaying) return
        setSessionTime(prevTime => timing(prevTime) + 1 > 60 ? 1 * 60 : prevTime + 60)
        setTotalTime(prevTime => timing(prevTime) + 1 > 60 ? 1 * 60 : prevTime + 60)
    }
    ...
    return (
        <div className="container">
            <div className="wrapper-clock">
                ...
                <div className="clock">
                    <audio id="audio" src="./assets/Bells.mp3" ref={audioRef}></audio>
                    <p id="timer-label">{isPlaying ? 'Break' : 'Session'}</p>
                ...
                <div className="buttons">
                    <button className="play" id="start_stop" onClick={() => setIsPlaying(p => !p)} ><img src={`/assets/${isPlaying ? 'stop.png' : 'play.png'}`} alt="play" /></button>
